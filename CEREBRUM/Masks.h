...
// Masks can have two primary states: colors and accesibility (can you pick it up?)
// If it is red, you can't pick that rod and the ones below

// B 	128  64	32	16	8	4	2	1 
const byte red = B10010000;
const byte green = B01000000;
